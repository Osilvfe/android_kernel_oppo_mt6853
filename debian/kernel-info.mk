...
# Defconfig to use
KERNEL_DEFCONFIG = mt6853_defconfig
...
# recommended.
FLASH_INFO_CPU = MediaTek MT6853

# Space-separated list of supported device ids as reported by fastboot
FLASH_INFO_DEVICE_IDS = 8LPNW4U4KBDUKN9H fastbootd
...
BUILD_PATH =/buildd/sources/gcc64/bin

# Extra packages to add to the Build-Depends section. Mainline builds
# can have this section empty, unless cross-building.
# The default is enough to install the Android toolchain, including clang.
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, clang, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross
